...
The owner has verified the domain property and supplied screenshots confirming indexing. Keep the DNS verification record. For this release, use the existing property and sitemap; no new ownership verification is needed. The instructions below also document initial setup.
...
- If targeting a specific city or service area, first confirm the actual location/service area and add it naturally to visible copy. Current copy targets businesses in San Antonio and beyond without claiming a local office.
...
## September 2026 local search release
