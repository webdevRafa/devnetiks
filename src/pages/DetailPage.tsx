...
export default function DetailPage() {
  ...
  return <div className="detail-page">
    ...
    <main id="main-content" className="detail-main">
      ...
      {page.images?.slice(0, 1).map(image => <figure className="detail-image" key={image.src}><img src={image.src} alt={image.alt} width={image.width} height={image.height} loading="lazy" decoding="async" /><figcaption>{image.caption}</figcaption></figure>)}
